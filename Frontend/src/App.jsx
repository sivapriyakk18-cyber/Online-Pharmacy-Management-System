...
export default function App() {
  ...
  const features = [
    ...
    {
      title: 'Secure Login',
      desc: 'Separate login for Admin, Pharmacist, Customer and Delivery Agent.',
      icon: '🔒',
    },
            ...
            <div className="font-sans bg-gray-100 min-h-screen">
              ...
              <nav className="bg-teal-700 text-white px-8 py-4 flex justify-between items-center fixed top-0 left-0 right-0 z-50 shadow-lg">
                ...
                <ul className="flex gap-6 font-medium">
                  ...
                  <li
                    onClick={() =>
                      document.getElementById("Login Portal").scrollIntoView({
                        behavior: "smooth"
                      })
                    }
                    className="cursor-pointer hover:text-gray-200"
              ...
              >
                ...
                <div className="max-w-4xl mx-auto">
                  ...
                  <p className="text-gray-700 text-lg leading-8">
                    ...
                    inventory management, pharmacist management, and secure delivery services.
